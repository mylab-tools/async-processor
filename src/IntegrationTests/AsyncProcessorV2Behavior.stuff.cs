...
namespace IntegrationTests
{
    ...
    {
        private readonly TestApi<Startup, IAsyncProcessorRequestsApiV2> _asyncProcTestApi;
        ...
        /// </summary>
        public AsyncProcessorV2Behavior(
            TestApi<Startup, IAsyncProcessorRequestsApiV2> asyncProcTestApi,
        ...
        MqCallback CreateCallback()
        {
            ...
            return new MqCallback(queue, exchange);
        }

        private (TestApiClient<IAsyncProcessorRequestsApiV2> AsyncProcApi, TestApiClient<IProcessorApi> ProcApi) Prepare(string callbackExchangeName, ILostRequestEventHandler lostRequestEventHandler = null, int reqIdleTimeoutSec = 300)
        {
        ...
        private async Task<string> SendRequest(
            TestRequest request,
            TestApiClient<IAsyncProcessorRequestsApiV2> api,
        ...
        private async Task<T> GetResult<T>(
            (TestApiClient<IAsyncProcessorRequestsApiV2> AsyncProcApi, TestApiClient<IProcessorApi> ProcApi) api,
            Expression<Func<IAsyncProcessorRequestsApiV2, Task<T>>> call)
        {
        ...
        private TestApiClient<IAsyncProcessorRequestsApiV2> StartAsyncProcApi(
            RabbitQueue queue,
